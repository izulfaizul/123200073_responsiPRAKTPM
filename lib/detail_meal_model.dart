class DetailMeal {
  final List<DetailMeals>? meals;

  DetailMeal({
    this.meals,
  });

  DetailMeal.fromJson(Map<String, dynamic> json)
    : meals = (json['DetailMeals'] as List?)?.map((dynamic e) => DetailMeals.fromJson(e as Map<String,dynamic>)).toList();

  Map<String, dynamic> toJson() => {
    'DetailMeals' : meals?.map((e) => e.toJson()).toList()
  };
}
